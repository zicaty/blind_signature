...
public class SM9EncMasterKeyPair implements org.apache.thrift.TBase<SM9EncMasterKeyPair, SM9EncMasterKeyPair._Fields>, java.io.Serializable, Cloneable, Comparable<SM9EncMasterKeyPair> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SM9EncMasterKeyPair");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SM9EncMasterKeyPairStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SM9EncMasterKeyPairTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SM9EncMasterKeyPair.class, metaDataMap);
  }

  public SM9EncMasterKeyPair() {
  }
   ...
   */
  public SM9EncMasterKeyPair(SM9EncMasterKeyPair other) {
  ...
  @Override
  public SM9EncMasterKeyPair deepCopy() {
    return new SM9EncMasterKeyPair(this);
  }
  ...
  public SM9EncMasterKeyPair setPrivateKey(byte[] privateKey) {
    this.privateKey = privateKey == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(privateKey.clone());
    return this;
  }

  public SM9EncMasterKeyPair setPrivateKey(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer privateKey) {
    this.privateKey = org.apache.thrift.TBaseHelper.copyBinary(privateKey);
    return this;
  }
  ...
  public SM9EncMasterKeyPair setPublicKey(byte[] publicKey) {
    this.publicKey = publicKey == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(publicKey.clone());
    return this;
  }

  public SM9EncMasterKeyPair setPublicKey(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer publicKey) {
    this.publicKey = org.apache.thrift.TBaseHelper.copyBinary(publicKey);
    return this;
  }
  ...
  public SM9EncMasterKeyPair setPairG(byte[] pairG) {
    this.pairG = pairG == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(pairG.clone());
    return this;
  }

  public SM9EncMasterKeyPair setPairG(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer pairG) {
    this.pairG = org.apache.thrift.TBaseHelper.copyBinary(pairG);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof SM9EncMasterKeyPair)
      return this.equals((SM9EncMasterKeyPair)that);
    return false;
  }

  public boolean equals(SM9EncMasterKeyPair that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SM9EncMasterKeyPair other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SM9EncMasterKeyPair(");
    boolean first = true;
  ...
  private static class SM9EncMasterKeyPairStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SM9EncMasterKeyPairStandardScheme getScheme() {
      return new SM9EncMasterKeyPairStandardScheme();
    }
  }

  private static class SM9EncMasterKeyPairStandardScheme extends org.apache.thrift.scheme.StandardScheme<SM9EncMasterKeyPair> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, SM9EncMasterKeyPair struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, SM9EncMasterKeyPair struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SM9EncMasterKeyPairTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SM9EncMasterKeyPairTupleScheme getScheme() {
      return new SM9EncMasterKeyPairTupleScheme();
    }
  }

  private static class SM9EncMasterKeyPairTupleScheme extends org.apache.thrift.scheme.TupleScheme<SM9EncMasterKeyPair> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SM9EncMasterKeyPair struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SM9EncMasterKeyPair struct) throws org.apache.thrift.TException {
