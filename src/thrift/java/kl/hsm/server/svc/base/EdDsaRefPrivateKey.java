...
public class EdDsaRefPrivateKey implements org.apache.thrift.TBase<EdDsaRefPrivateKey, EdDsaRefPrivateKey._Fields>, java.io.Serializable, Cloneable, Comparable<EdDsaRefPrivateKey> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EdDsaRefPrivateKey");
  ...
  private static final org.apache.thrift.protocol.TField K_FIELD_DESC = new org.apache.thrift.protocol.TField("k", org.apache.thrift.protocol.TType.STRING, (short)3);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new EdDsaRefPrivateKeyStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new EdDsaRefPrivateKeyTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EdDsaRefPrivateKey.class, metaDataMap);
  }
   ...
   */
  public EdDsaRefPrivateKey(EdDsaRefPrivateKey other) {
  ...
  @Override
  public EdDsaRefPrivateKey deepCopy() {
    return new EdDsaRefPrivateKey(this);
  }
  ...
  public EdDsaRefPrivateKey setBits(int bits) {
    this.bits = bits;
    setBitsIsSet(true);
    return this;
  }
  ...
  public EdDsaRefPrivateKey setCurveType(int curveType) {
    this.curveType = curveType;
    setCurveTypeIsSet(true);
    return this;
  }
  ...
  public EdDsaRefPrivateKey setK(byte[] k) {
    this.k = k == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(k.clone());
    return this;
  }

  public EdDsaRefPrivateKey setK(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer k) {
    this.k = org.apache.thrift.TBaseHelper.copyBinary(k);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof EdDsaRefPrivateKey)
      return this.equals((EdDsaRefPrivateKey)that);
    return false;
  }

  public boolean equals(EdDsaRefPrivateKey that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(EdDsaRefPrivateKey other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("EdDsaRefPrivateKey(");
    boolean first = true;
  ...
  private static class EdDsaRefPrivateKeyStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public EdDsaRefPrivateKeyStandardScheme getScheme() {
      return new EdDsaRefPrivateKeyStandardScheme();
    }
  }

  private static class EdDsaRefPrivateKeyStandardScheme extends org.apache.thrift.scheme.StandardScheme<EdDsaRefPrivateKey> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, EdDsaRefPrivateKey struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, EdDsaRefPrivateKey struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class EdDsaRefPrivateKeyTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public EdDsaRefPrivateKeyTupleScheme getScheme() {
      return new EdDsaRefPrivateKeyTupleScheme();
    }
  }

  private static class EdDsaRefPrivateKeyTupleScheme extends org.apache.thrift.scheme.TupleScheme<EdDsaRefPrivateKey> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EdDsaRefPrivateKey struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EdDsaRefPrivateKey struct) throws org.apache.thrift.TException {
