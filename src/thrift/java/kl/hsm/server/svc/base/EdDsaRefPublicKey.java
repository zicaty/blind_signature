...
public class EdDsaRefPublicKey implements org.apache.thrift.TBase<EdDsaRefPublicKey, EdDsaRefPublicKey._Fields>, java.io.Serializable, Cloneable, Comparable<EdDsaRefPublicKey> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EdDsaRefPublicKey");
  ...
  private static final org.apache.thrift.protocol.TField A_FIELD_DESC = new org.apache.thrift.protocol.TField("a", org.apache.thrift.protocol.TType.STRING, (short)3);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new EdDsaRefPublicKeyStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new EdDsaRefPublicKeyTupleSchemeFactory();

  public int bits; // required
  public int curveType; // required
  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer a; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EdDsaRefPublicKey.class, metaDataMap);
  }
    ...
    java.nio.ByteBuffer a)
  {
    ...
    this.a = org.apache.thrift.TBaseHelper.copyBinary(a);
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public EdDsaRefPublicKey(EdDsaRefPublicKey other) {
    __isset_bitfield = other.__isset_bitfield;
    this.bits = other.bits;
    this.curveType = other.curveType;
    if (other.isSetA()) {
      this.a = org.apache.thrift.TBaseHelper.copyBinary(other.a);
    }
  }

  @Override
  public EdDsaRefPublicKey deepCopy() {
    return new EdDsaRefPublicKey(this);
  }
  ...
  public EdDsaRefPublicKey setBits(int bits) {
    this.bits = bits;
    setBitsIsSet(true);
    return this;
  }
  ...
  public EdDsaRefPublicKey setCurveType(int curveType) {
    this.curveType = curveType;
    setCurveTypeIsSet(true);
    return this;
  }
  ...
  public byte[] getA() {
    setA(org.apache.thrift.TBaseHelper.rightSize(a));
    return a == null ? null : a.array();
  }

  public java.nio.ByteBuffer bufferForA() {
    return org.apache.thrift.TBaseHelper.copyBinary(a);
  }

  public EdDsaRefPublicKey setA(byte[] a) {
    this.a = a == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(a.clone());
    return this;
  }

  public EdDsaRefPublicKey setA(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer a) {
    this.a = org.apache.thrift.TBaseHelper.copyBinary(a);
    return this;
  }
    ...
    case A:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          ...
          setA((java.nio.ByteBuffer)value);
        }
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof EdDsaRefPublicKey)
      return this.equals((EdDsaRefPublicKey)that);
    return false;
  }

  public boolean equals(EdDsaRefPublicKey that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(EdDsaRefPublicKey other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("EdDsaRefPublicKey(");
    boolean first = true;
    ...
    if (this.a == null) {
      ...
      org.apache.thrift.TBaseHelper.toString(this.a, sb);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class EdDsaRefPublicKeyStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public EdDsaRefPublicKeyStandardScheme getScheme() {
      return new EdDsaRefPublicKeyStandardScheme();
    }
  }

  private static class EdDsaRefPublicKeyStandardScheme extends org.apache.thrift.scheme.StandardScheme<EdDsaRefPublicKey> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, EdDsaRefPublicKey struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, EdDsaRefPublicKey struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class EdDsaRefPublicKeyTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public EdDsaRefPublicKeyTupleScheme getScheme() {
      return new EdDsaRefPublicKeyTupleScheme();
    }
  }

  private static class EdDsaRefPublicKeyTupleScheme extends org.apache.thrift.scheme.TupleScheme<EdDsaRefPublicKey> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EdDsaRefPublicKey struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EdDsaRefPublicKey struct) throws org.apache.thrift.TException {
